        ...
        <div class="conta_area_eventos">
          ...
          <div class="duas-caixa">
            <div class="caixa-direita busca-contas">
                ...
                <div class="janela busca_janela" >
                    ...
                    <div class="busca_janela_expandido down_comum expandido">
                      <a>1</a>
                      <a>2</a>
                    </div>
                </div>
            ...
            <div class="caixa-esquerda btn_add_conta">
                <a href="view_disciplina_add.php" class="btn">Adicionar</a>
            </div>
          </div>
          ...
          <table class="tabela">
              ...
              <div class="linha_tabela">
                <tr>
                  <td class="codgo_conta" id="id_conta">INF09093</td>
                  <td class="nome_conta">Interfaces e Periféricos</td>
                <td class="acao_conta">
                  <div class="btn_icone"><a href="view_disciplina_edita.php" class="btn-primary"><i class="far fa-edit"></i>Editar </i></a></div>
            ...
            <div class="linha_tabela">
              <tr>
                  <td class="codgo_conta" id="id_conta">INF09094</td>
                  <td class="nome_conta">Interfaces e Periféricos II</td>
                  <td class="acao_conta">
                  <div class="btn_icone"><a href="view_disciplina_edita.php" class="btn-primary"><i class="far fa-edit"></i>Editar</a></div>
